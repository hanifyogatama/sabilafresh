{!! Form::open(['url'=> Request::path(),'method'=>'GET','class' => 'input-daterange form-inline']) !!}
        <input type="text" class="form-control input-block form-control-sm" name="searchInput" value="{{ !empty(request()->input('searchInput')) ? request()->input('searchInput') : '' }}" placeholder="nama">
