						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="checkout-form-list">
									...
									{!! Form::select('provinsi_id', $provinces, Auth::user()->provinsi_id, ['id' => 'province-id', 'placeholder' => '- Please Select - ', 'required' => true]) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="checkout-form-list">
									<label>City<span class="required">*</span></label>
									{!! Form::select('kota_id', $cities, null, ['id' => 'city-id', 'placeholder' => '- Please Select -', 'required' => true])!!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="checkout-form-list">
								...
								<tbody>
									@forelse ($items as $item)
										@php
											...
											$image = !empty($product->productImages->first()) ? asset('storage/'.$product->productImages->first()->path) : asset('themes/sabilafresh/assets/img/cart/3.jpg')
										@endphp
										<tr class="cart_item">
