						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="checkout-form-list">
									...
									{!! Form::select('provinsi_id', $provinces, Auth::user()->province_id, ['id' => 'province-id', 'placeholder' => '- Please Select - ', 'required' => true]) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="checkout-form-list">
							...
							<div class="col-md-6">
								<div class="checkout-form-list">
									...
									{!! Form::number('kode pos', null, ['required' => true, 'placeholder' => 'Postcode']) !!}
								</div>
							</div>
							<div class="col-md-6">
								<div class="checkout-form-list">
