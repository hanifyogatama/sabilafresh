<div class="slider-area">
    <div class="slider-active owl-carousel">
        <div class="single-slider-4 slider-height-6 bg-img" style="background-image: url({{ asset('themes/sabilafresh/assets/img/slider/9.jpg') }})">
            <div class="container">
                <div class="row">
        ...
        <div class="single-slider-4 slider-height-6 bg-img" style="background-image: url({{ asset('themes/sabilafresh/assets/img/slider/19.jpg') }})">
            <div class="container">
                <div class="row">
                    <div class="ml-auto col-lg-6">
                        <div class="furniture-content fadeinup-animated">
